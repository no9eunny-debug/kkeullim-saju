...
const LUCKY_ITEMS: Record<string, { name: string; desc: string; emoji: string; url: string }[]> = {
  목: [
    ...
    { name: "원석 펜던트 목걸이", desc: "천연 원석 행운 목걸이", emoji: "📿", url: "https://naver.me/FXnru3NL" },
    { name: "우디향 디퓨저", desc: "나무향 목 기운 충전", emoji: "🌳", url: "https://link.coupang.com/a/eyNGFH" },
  ...
  화: [
    ...
    { name: "탄생석 목걸이", desc: "나만의 탄생석 행운 주얼리", emoji: "💎", url: "https://naver.me/5vJYkB8M" },
    { name: "LED 무드등", desc: "따뜻한 불빛 화 기운 인테리어", emoji: "💡", url: "https://naver.me/F4WtvNbb" },
  ...
  토: [
    ...
    { name: "아로마 디퓨저 세트", desc: "안정감 있는 힐링 디퓨저", emoji: "🧘", url: "https://naver.me/xiL5Ov1M" },
    { name: "감성 무드등", desc: "포근한 토 기운 조명", emoji: "🌙", url: "https://naver.me/GVVWwSib" },
  ...
  금: [
    ...
    { name: "원석 펜던트 목걸이", desc: "세련된 금 기운 주얼리", emoji: "📿", url: "https://naver.me/FXnru3NL" },
  ...
  수: [
    ...
    { name: "미니 가습기", desc: "수 기운 충전 촉촉 가습기", emoji: "💧", url: "https://naver.me/5yhqR471" },
    { name: "미니 무드 가습기", desc: "무드등 겸용 수 기운 아이템", emoji: "🌊", url: "https://naver.me/5xgnAlPm" },
    { name: "시원한 디퓨저", desc: "오션향 수 기운 디퓨저", emoji: "🐚", url: "https://link.coupang.com/a/eyNGFH" },
  ],
};
