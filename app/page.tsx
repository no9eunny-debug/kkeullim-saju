...
const sampleResults = [
  {
    label: "연애운",
    tag: "ENFP + 1996년생 여성",
    text: "있잖아요, 겉으로는 되게 쿨한 척하는데 속으로는 진심으로 이해해주는 사람을 엄청 원하는 스타일이에요.\n\nENFP라서 사람 만나는 건 좋아하는데, 사주를 보니까 정작 마음을 여는 데 시간이 걸리는 타입이더라고요. 이 갭이 매력이기도 한데...",
  },
  {
    label: "재물운",
    tag: "INTJ + 1990년생 남성",
    text: "솔직히 이 사주는 돈 흐름 읽는 감각이 좀 남다른 편이에요.\n\nINTJ의 전략적인 머리에, 사주에서도 재물을 오래 굴리는 에너지가 있거든요. 한 방보다는 장기전에서 빛나는 타입! 근데 올해 하반기에 좀 재밌는 흐름이 보여요...",
  },
  {
    label: "궁합",
    tag: "ISFJ 여성 + ENTP 남성",
    text: "이 조합 진짜 재밌거든요. 처음엔 '완전 다른 사람인데?' 하다가 점점 빠지는 케이스예요.\n\nISFJ의 따뜻한 배려랑 ENTP의 엉뚱한 아이디어가 만나면 의외로 시너지가 나요. 다만 생활 습관 차이는 좀 맞춰가야 하는데...",
  },
];
...
const faqs = [
  ...
  { q: "분석 결과는 얼마나 정확한가요?", a: "만세력 기반으로 정확한 사주 데이터를 확보하고, 여러 AI가 교차 분석해요. 단일 AI보다 훨씬 균형 잡힌 결과를 제공해요." },
  { q: "무료로도 이용할 수 있나요?", a: "비회원도 하루 3회까지 체험 가능하고, 무료 회원은 하루 7회까지 분석받을 수 있어요. 더 깊은 분석은 베이직·프리미엄 플랜을 이용해보세요." },
...
const plans = [
  {
    ...
    features: ["하루 7회 간단 분석", "기본 성향 + MBTI 요약", "단일 카테고리"],
